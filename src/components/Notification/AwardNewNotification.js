...
const AwardNewNotification = ({ notification, removeNotification }) => {
    ...
    return (
        <li>
            <div>
                ...
                <p className="heading">Pojawiła się nowa nagroda!</p>
                <div className="textWrapper">
                    <p className="text">
                        Jest to <span>{notification.awardTitle}</span> i aby ją zdobyć potrzebujesz <span> {notification.awardCost} </span>
                        punktów. Wejdz w nagrody aby zobaczyć więcej.
                    </p>
                </div>
...
export default connect(null, mapDispatchToProps)(AwardNewNotification);
